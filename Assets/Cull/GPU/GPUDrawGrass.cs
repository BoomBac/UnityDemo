...
public class GPUDrawGrass : MonoBehaviour
{
    ...
    private CullCommon.Plane[] cameara_planes_;
    ...
    void Start()
    {
        kernel = compute.FindKernel("VFCull");
        mainCamera = Camera.main;
        cameara_planes_ = new CullCommon.Plane[6];
    ...
    void Update()
    {
        ...
        var planes =  CullCommon.GetVirwFrustumPlane(mainCamera);
    ...
    void UpdateBuffers()
    {
        ...
        for (int i = 0; i < instanceCount; i++)
        {
            ...
            float height = Random.Range(0.0f, 2.0f);
